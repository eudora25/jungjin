...
/**
 * 플랫폼 — 병의원 공공데이터 CSV 일괄 등록 (super_admin). (GAP-10 마스터 CRUD)
 */
class HospitalImportController extends Controller
{
    ...
    public function form(Request $request): Response
    {
        ...
        return Inertia::render('Clients/Hospitals/Import', [
            ...
            'analysis' => null,
            'handleRoute' => 'platform.hospitals.import.handle',
            'indexRoute' => 'platform.hospitals.index',
        ]);
    }
    ...
    public function handle(ImportHospitalsRequest $request): RedirectResponse|Response
    {
        ...
        return redirect()->route('platform.hospitals.index')->with('success', $msg);
    }
}
