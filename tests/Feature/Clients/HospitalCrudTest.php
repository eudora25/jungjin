...
test('admin 은 병의원 목록을 조회할 수 있다', function () {
...
test('admin 이 병의원을 등록한다', function () {
    $this->actingAs($this->admin)
...
test('sales 는 병의원을 등록할 수 없다', function () {
...
test('병의원 삭제(soft delete)', function () {
